...
# cd ../template
thrift=~/thrift-0.9.2
JAVA_CLASS_PATH=$thrift/lib/java/build/libthrift-0.9.2.jar:$thrift/lib/java/build/lib/slf4j-api-1.5.8.jar:$thrift/lib/java/build/lib/slf4j-log4j12-1.5.8.jar:$thrift/lib/java/build/lib/log4j-1.2.14.jar:httpcomponents-core-4.4.1/lib/commons-cli-1.2.jar:httpcomponents-core-4.4.1/lib/httpcore-4.4.1.jar:httpcomponents-core-4.4.1/lib/httpcore-ab-4.4.1.jar:httpcomponents-core-4.4.1/lib/httpcore-nio-4.4.1.jar
